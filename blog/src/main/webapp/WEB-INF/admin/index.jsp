...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>晨曦的博客</b>CXZ</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="#"><i class="fa fa-link"></i> <span>编辑新文章</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
       <div class="row">
		...
		<div class="form-group">
                  <label>文章标签：</label>
                  <input type="text" name="tag" class="form-control" placeholder="java,spring,redis,....">
                </div>
		         <div class="form-group">
                  <div class="checkbox">
                    <label>
